...
Plusieurs tests complementaires sont recommandes pour prolonger le travail. Le premier est un test de charge prolonge, sur plusieurs heures ou plusieurs jours, afin de mesurer la stabilite de l'API, du pipeline et du dashboard. Le deuxieme est un test multi-machine, avec plusieurs collecteurs et un bus central. Le troisieme est un test de panne plus large, au-dela du scenario Redis deja valide avant acquittement, pour observer la reprise sur des taches plus longues et des volumes plus importants.
...
Lorsque les articles seront disponibles, ils pourront etre ajoutes en annexe ou references dans une section dediee. Ils permettront de valoriser certains aspects du travail, par exemple l'architecture multi-agents, les resultats experimentaux, la scalabilite ou la comparaison avec des outils standards. Pour l'instant, le memoire se concentre sur le prototype, les resultats disponibles et les preuves locales.
