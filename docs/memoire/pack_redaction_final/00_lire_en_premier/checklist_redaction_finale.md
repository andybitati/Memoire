...
| Benchmark temps reel | pret | 10 cycles, moyenne 8.2012 s |
...
| Resultats, filtres et anomalies | pret | `docs/memoire/captures/dashboard_resultats_detail_incident.png` |
| Detail incident | pret | `docs/memoire/captures/dashboard_resultats_detail_incident.png` |
| Decisions analyste et audit | pret | `docs/memoire/captures/dashboard_resultats_detail_incident.png`, `docs/memoire/captures/dashboard_ressources_audit.png` |
| Ressources CPU/RAM agents | pret | `docs/memoire/captures/dashboard_ressources_audit.png` |
...
captures dashboard sont prets pour passer a la redaction. Les captures mobile
ou fenetre reduite restent optionnelles pour une annexe ou une demonstration.
