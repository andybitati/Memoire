...
| Temps reel | 5 cycles, latence moyenne 10.6473 s |
...
- captures dashboard finales encore a produire pour le manuscrit;
...
| 5. Dashboard interactif | Conforme prototype, captures finales a produire |
...
- Vue d'ensemble avec compteurs et graphiques temps reel;
- timeline/heatmap remplie;
- tableau des anomalies candidates;
- detail incident avec justification;
- decisions analyste et audit;
- ressources CPU/RAM par agent;
- export CSV ou preuve de fichiers resultats.

Nom de fichiers recommande:

- `docs/memoire/captures/dashboard_vue_ensemble.png`;
- `docs/memoire/captures/dashboard_timeline_heatmap.png`;
