...
| Redis Streams | Integre comme bus evenementiel optionnel pour FastAPI et les agents | `RedisMessageBus`, `/redis/health`, `/events`, `docker-compose.redis.yml`, `use_redis=true` | Valide localement sur 150 taches agents; pas encore valide comme couche d'ingestion SOC sous forte charge |
