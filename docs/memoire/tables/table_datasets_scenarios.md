...
| Public reseau | CIC-DDoS2019 | Flux reseau/DDoS | Evaluation exploratoire par chunks, resultat a revalider par split fichier/scenario | random_forest_unsw_80_20_metrics.csv |
