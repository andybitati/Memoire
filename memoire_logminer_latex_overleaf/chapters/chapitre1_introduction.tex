...
Le memoire repose sur quatre hypotheses prudentes, formulees de maniere operationnelle. Premierement, les journaux heterogenes peuvent etre rapproches par un noyau commun de champs tout en conservant les donnees originales utiles a l'audit. Deuxiemement, une architecture par agents logiciels specialises peut ameliorer la modularite, la tracabilite et la robustesse d'execution par rapport a une chaine monolithique. Cette hypothese est verifiee par la progression fonctionnelle du prototype et par la campagne Redis locale de six heures. Troisiemement, le routage par famille de logs constitue une hypothese de conception : il doit reduire l'incompatibilite entre source, features et modele, mais sa superiorite quantitative sur un modele global unique demande une experience controlee complementaire. Quatriemement, les modeles legers restent utiles dans une chaine locale reproductible lorsqu'ils sont mesures avec des metriques explicites, associes a une correlation et soumis a une validation humaine.
