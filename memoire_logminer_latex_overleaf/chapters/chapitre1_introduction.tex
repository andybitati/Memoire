...
\begin{quote}
Comment concevoir un prototype local, modulaire et exploitable par un analyste, capable de detecter et de prioriser des anomalies candidates dans des journaux systemes et reseaux heterogenes par traitements periodiques ou par micro-lots ?
\end{quote}
...
\begin{enumerate}
  ...
  \item Concevoir une architecture locale de modules specialises, extensible vers une orchestration distribuee.
...
Le travail est centre sur la conception, l'implementation et l'evaluation d'un prototype local reproductible. La distribution est traitee comme une decomposition logique en modules cooperants et comme une trajectoire technique preparee par FastAPI, Redis Streams et MQTT. Elle n'est pas revendiquee comme un deploiement industriel multi-site complet. De meme, les resultats supervises mesurent la performance sur les datasets utilises ; ils ne prouvent pas une generalisation automatique a toutes les infrastructures reelles.
...
Le memoire suit la structure du document directeur, enrichie par un chapitre de reproductibilite utile a la verification du travail. Le chapitre 2 presente l'etat de l'art. Le chapitre 3 decrit le modele propose et l'architecture modulaire. Le chapitre 4 presente l'implementation du prototype. Le chapitre 5 analyse les resultats experimentaux. Le chapitre 6 approfondit les limites scientifiques, les risques de validite et les corrections methodologiques. Le chapitre 7 discute la valeur pratique du prototype. Le chapitre 8 presente la reproductibilite, le depot GitHub, les scenarios de deploiement et les precautions d'exploitation. Le dernier chapitre conclut le travail et propose les perspectives. Les annexes regroupent les tableaux, captures, figures et elements de reproductibilite.
...
\section{Contraintes et choix initiaux}
...
Ces choix initiaux structurent tout le memoire. Ils expliquent pourquoi le prototype privilegie des modeles legers, pourquoi le dashboard est integre a la contribution, pourquoi les annexes contiennent des preuves de reproduction et pourquoi les limites sont discutees explicitement.
