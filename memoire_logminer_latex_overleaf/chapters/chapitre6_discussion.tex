...
Apres ces corrections, le memoire defend environ 95\% de l'objectif initial si l'on interprete le titre selon le perimetre experimental annonce : detection locale multi-source, agents logiciels multi-taches, distribution locale multi-processus, endurance de six heures, reprise apres panne et evaluation quantitative. Les 5\% restants correspondent aux preuves industrielles qui demandent plus de temps : deploiement sur plusieurs machines, charge sur plusieurs jours, securisation inter-noeuds, evaluation temporelle plus stricte et reduction avancee des faux positifs.
