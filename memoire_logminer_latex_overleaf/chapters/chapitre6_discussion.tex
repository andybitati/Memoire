...
Les perspectives peuvent etre organisees par priorite scientifique. La premiere priorite est la comparaison controlee entre pipeline global unique et routage familial avec modeles specialises, sur les memes jeux de donnees, les memes splits et plusieurs graines. Cette experience devra rapporter F1, precision, rappel, faux positifs, PR-AUC, MCC, matrices de confusion, latence et consommation memoire.

La deuxieme priorite est l'amelioration de la representation des logs sequentiels. Les resultats HDFS montrent qu'une approche ligne par ligne reste limitee pour certains systemes. L'ajout de templates, de fenetres temporelles et de modeles sequentiels permettrait de mieux capturer les comportements collectifs.
