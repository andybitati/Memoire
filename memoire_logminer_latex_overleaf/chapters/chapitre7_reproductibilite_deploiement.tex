...
Redis Streams et MQTT ont ete explores comme extensions operationnelles locales. Redis Streams peut servir a conserver des flux d'evenements ordonnes et consommables par plusieurs workers. MQTT peut faciliter une communication legere entre composants. Ces pistes sont interessantes, mais elles demandent encore des tests de charge, des mecanismes de securisation, une gestion des erreurs et une strategie de reprise apres panne.
...
Plusieurs tests complementaires sont recommandes pour prolonger le travail. Le premier est un test de charge prolonge, sur plusieurs heures ou plusieurs jours, afin de mesurer la stabilite de l'API, du pipeline et du dashboard. Le deuxieme est un test multi-machine, avec plusieurs collecteurs et un bus central. Le troisieme est un test de panne, ou un agent est volontairement arrete puis relance pour observer la reprise.
