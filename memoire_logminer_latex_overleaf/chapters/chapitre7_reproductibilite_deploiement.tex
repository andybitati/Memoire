...
Deux machines virtuelles VirtualBox etaient lancees pendant l'experience : \texttt{Debian} et \texttt{Ubuntu}. Elles etaient configurees en NAT simple et accedaient au Redis Windows par l'adresse \texttt{redis://10.0.2.2:6379/0}. La campagne de six heures reste locale a l'hote, mais trois campagnes complementaires ont ete executees en multi-VM : une campagne equilibree Debian/Ubuntu de douze taches, une campagne panne/reprise dans laquelle Debian prend une tache avant panne simulee et Ubuntu la recupere, puis une campagne d'endurance supervisee d'une heure. Cette derniere enfile 525 taches et se termine avec 525 entrees lues par le groupe Redis, un lag final nul et aucun pending. La conclusion experimentale devient donc plus precise : le memoire valide une distribution locale multi-processus, une endurance de six heures, une reprise repetee des taches non acquittees et une preuve multi-VM de laboratoire ; il ne revendique pas encore une validation SOC multi-site securisee.
