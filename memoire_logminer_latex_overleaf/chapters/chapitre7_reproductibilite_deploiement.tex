...
\begin{center}
\path{python scripts/monthly_model_retraining.py}
\end{center}
...
\begin{center}
\path{python scripts/monthly_model_retraining.py --plan docs/model_training/monthly_retraining_plan.example.json --dry-run}
\end{center}
