...
| Chapitre 2 — architecture | Décrire les classes multi-agents réellement utilisées, le cycle CNP et la politique d’utilité ; distinguer coordination métier et transport Redis/MQTT. | code `src/logminer/agents`, `docs/TRUE_MULTI_AGENT_ARCHITECTURE.md` |
