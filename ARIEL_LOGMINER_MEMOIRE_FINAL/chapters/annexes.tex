...
\caption{Traçabilité des résultats finaux.}\label{tab:preuves-finales}\\
\toprule
...
Multi-format & 7,001/7,001 & \texttt{multiformat\_balanced\_summary.csv} \\
...
Multi-VM & 60/60 ; 30/30 & \texttt{multivm\_cnp\_20260909T202632Z\_37592\_\_redis\_cnp\_multivm.json} \\
Corrélation & F1 0,812500 & Artefact final de corrélation synthétique. \\
\bottomrule
\end{longtable}
...
\begin{table}[H]
\centering
\caption{Configuration finale HDFS vérifiée.}
...
Seuil final & 1,2729429339548877, choisi sur validation \\
...
\begin{table}[H]
\centering
\caption{Configuration et observations de la campagne multi-VM retenue.}
...
\midrule
Run & \texttt{multivm\_cnp\_20260909T202632Z\_37592} \\
...
Durée & 2,712455 s \\
Tâches & 60 réussies sur 60 ; 30 par agent \\
Décisions & 108 propositions, 15 refus, 63 attributions \\
Reprise & un \texttt{FAIL} contrôlé, une réattribution \\
Idempotence & un effet persistant, zéro effet dupliqué lors du replay \\
\bottomrule
\end{tabularx}
\end{table}
...
Promotion/rejet observé & NON ÉVALUÉ & Pas de cycle final complet et répété démontré. \\
