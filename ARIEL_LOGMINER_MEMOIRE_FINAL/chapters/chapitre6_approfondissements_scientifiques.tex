...
L'ancienne branche DDoS et l'archive historique mal identifiee sont exclues du corpus scientifique final. Le dataset UNSW-NB15 n'est pas fusionne avec CICIDS2017 et aucune performance issue de cette branche n'est utilisee pour etayer les conclusions.
...
La distribution doit etre lue en deux niveaux. La campagne Redis de six heures montre une repartition locale multi-processus et une reprise de taches non acquittees sur l'hote Windows. Une validation separee sous VirtualBox montre ensuite que Debian et Ubuntu peuvent consommer un stream Redis commun heberge sur l'hote, avec notamment 525 taches lues et acquittees par le groupe Redis pendant une campagne supervisee d'une heure. Une comparaison controlee monolithique-versus-agents a ete ajoutee sur les memes taches et le meme volume : elle ne montre pas de gain de debit sur petit volume, mais elle quantifie l'overhead d'orchestration et confirme la reprise d'une tache simulee comme non acquittee. La modularite et la tracabilite sont soutenues par la conception logicielle et les mecanismes d'audit ; la resilience locale et la distribution de laboratoire disposent, elles, de preuves experimentales distinctes.
...
Branche DDoS historique / UNSW & Attribution dataset ambigue. & Les sources sont separees ; la branche DDoS historique est exclue du corpus final. \\
...
Scalabilite & Campagne locale de six heures et validation VirtualBox d'une heure ne suffisent pas pour une preuve industrielle. & Les mesures documentent la faisabilite locale et inter-machines de laboratoire ; la scalabilite SOC multi-site securisee reste une perspective. \\
\bottomrule
\end{tabularx}
\end{table}
