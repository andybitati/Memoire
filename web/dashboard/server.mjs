...
async function handleServices(req, res) {
  try {
    const [health, redisHealth, redisPending, models, runtime] = await Promise.allSettled([
    ...
    sendJson(res, 200, { apiBase: fastApiBase, api: { status: "down", error: error.message }, redis: { status: "down" }, redisPending: {}, models: [], runtime: {} });
  }
}
